...
PR 04 - STUDENTVERSE is a premium student management dashboard built with Node.js, Express, EJS, MongoDB and Mongoose. It improves a basic student CRUD app with MVC structure, authentication, validation, search, filters, sorting, pagination, dashboard analytics, dark/light mode and polished responsive UI.
